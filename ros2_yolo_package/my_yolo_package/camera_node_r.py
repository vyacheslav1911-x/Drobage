#ros2 run my_yolo_package camera_node_r --ros-args -p video_fps:=30
...
class CameraNode(Node):
    def __init__(self):
        ...
        self.declare_parameter('video_src', 0)
        self.declare_parameter('video_fps', 5)
        video_src = self.get_parameter('video_src').get_parameter_value().integer_value
